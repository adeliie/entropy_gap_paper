...
if __name__ == "__main__":
    ...
    W_traj, target_traj, deltas, track_indices = simulate_sign_descent_3panels(
        d, T, eta
    )
    ...
    ax1.legend(
        lines, labels, loc="upper right", bbox_to_anchor=(1.05, 1.35), frameon=False
    )
    ...
    plt.savefig("plot/sign_weight.pdf", bbox_inches="tight")
