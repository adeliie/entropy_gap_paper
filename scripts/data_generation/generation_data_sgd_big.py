...
from package import algo_functions as f, DATA_FILE_SIGN_BIG

ds_p1 = [int(x) for x in [1e5, 1e6, 1e7]]
Ts_p1 = np.unique(np.geomspace(1, 200, 20).astype(int))

os.makedirs("data", exist_ok=True)
output_file = DATA_FILE_SIGN_BIG
